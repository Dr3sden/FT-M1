...
function counter() {
  ...
  retornando un valor numérico que empieza en 1 e incrementa con
  cada invocación.
  ...
  var n=0;
  //retorna las veces que se ejecuta
...
function cacheFunction(cb) {
  ...
  */
  //se crea el obj cache para guardar los valores
  const cache = {};
  ...
  return function(x){
    ...
    //se pasa al objeto el resultado de callback
    cache[x]=cb(x);
    //retorna el valor
    return cache[x];
  };
...
//retorna el nombre de instructor
...
//se pasa la cadena this junto con sus delimitadores en bind
